 ...
 */
class BeholderApplicationDev extends Application
{
	...
	function __construct() {
		...
		$map_info = array("hor_distance_m" => -1, "map_icon_id" => 0, "map_icon" => array());
		// マップ配列
		...
		$this->_maps['item_balenos']['hor_distance_m'] = "1200";
		$this->_maps['item_media']['hor_distance_m'] = "1770";
		$this->_maps['item_calpheon']['hor_distance_m'] = "1550";
		$this->_maps['item_valencia']['hor_distance_m'] = "1900";
		$this->_maps['item_serendia']['hor_distance_m'] = "2570";
	}
    ...
    {
		$client->send("notify_map:" . $map . "," . $this->_maps[$map]['hor_distance_m']);
    }
